        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnrichmentFailed = table.Column<int>(type: "int", nullable: false),
                    EmailsVerified = table.Column<int>(type: "int", nullable: false),
                    WhatsAppReachable = table.Column<int>(type: "int", nullable: false),
                    Skipped = table.Column<int>(type: "int", nullable: false),
                    Failed = table.Column<int>(type: "int", nullable: false),
                    CurrentTask = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WhatsApp = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    WhatsAppStatus = table.Column<int>(type: "int", nullable: false),
                    ...
                    MapsUrl = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: false),
                    Source = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    SearchJobId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DedupeWebsiteKey = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    DedupePhoneKey = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    DedupeNameKey = table.Column<string>(type: "nvarchar(384)", maxLength: 384, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Businesses_SearchJobs_SearchJobId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_SearchJobId",
                table: "ActivityLogs",
                column: "SearchJobId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Businesses_Country_City",
                table: "Businesses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Businesses_DedupeNameKey",
                table: "Businesses",
                column: "DedupeNameKey",
                filter: "[DedupeNameKey] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Businesses_DedupePhoneKey",
                table: "Businesses",
                column: "DedupePhoneKey",
                filter: "[DedupePhoneKey] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Businesses_DedupeWebsiteKey",
                table: "Businesses",
                column: "DedupeWebsiteKey",
                filter: "[DedupeWebsiteKey] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Businesses_EmailStatus",
                table: "Businesses",
                column: "EmailStatus");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Businesses_SearchJobId",
                table: "Businesses",
                column: "SearchJobId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Businesses_WhatsAppStatus",
                table: "Businesses",
                column: "WhatsAppStatus");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SearchJobs_StartedAt",
                table: "SearchJobs",
                column: "StartedAt");

            migrationBuilder.CreateIndex(
                name: "IX_SearchJobs_Status",
                table: "SearchJobs",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_SearchJobs_Status_HeartbeatAt",
                table: "SearchJobs",
